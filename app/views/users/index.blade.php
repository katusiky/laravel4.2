...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div id="sidebar-nav" class="hidden-xs">
        ...
        <ul id="dashboard-menu" class="nav nav-list">
            ...
            <li class=" "><a rel="tooltip" data-placement="right" data-original-title="Media" href="<?=URL::to('users'); ?>"><i class="fa fa-users"></i> <span class="caption">Usuarios</span></a></li> {{-- Este enlace es mas confiable, seguro y recomendado para laravel y sus links --}}
